...
public class Echiquier {
    ...
    public void initCaseEtPiece() {
     ...
     // idcase à enlever et new verification piece pose problème
      ...
      echiquier[59].setPiece(new Roi(false,"\u2654", echiquier[59], new VerificationPiece(this)));
      echiquier[60].setPiece(new Reine(false,"\u2655", echiquier[60], new VerificationPiece(this)));
    ...
    public String toString(){
        ...
        while(i >= 0){
            ...
            while( j <= 7){
                ...
                if(echiquier[i] != null) {
                    String unicode = echiquier[i*8+j].afficherPieceDelaCase();
                    retour+="|  "+unicode+" ";
                }
                else {
                    retour+="| "+"    ";
